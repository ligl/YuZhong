...
import cn.amose.yuzhong.adapter.SectionListAdapter;
...
public class SectionListView extends ListView implements OnScrollListener {
	...
	private boolean mIsEnableTransparentView;
	...
	public void setTrasparentViewEnabled(boolean enabled) {
		mIsEnableTransparentView = enabled;
	}
