...
public abstract class PullToRefreshBase<T extends AbsListView> extends
	...
	public final void onScroll(final AbsListView view,
		...
		if (null != onLastItemVisibleListener || null != onLoadMoreListener) {
			...
			if (visibleItemCount > 0 && visibleItemCount < totalItemCount
				...
				if (onLoadMoreListener != null && isLoadingMore == false) {
					onLoadMoreStart();
	...
	private void init(Context context, AttributeSet attrs) {
		...
		refreshingLabel = context
				.getString(R.string.pull_to_refresh_refreshing_label);
		releaseLabel = context
		...
		addView(header, index, new LinearLayout.LayoutParams(
		...
		if (a.hasValue(R.styleable.PullToRefresh_headerTextColor)) {
			headerText.setTextColor(a.getColor(
		...
		rotateToPointUpAnimation = new RotateAnimation(0, -180,
		...
		rotateToPointDownAnimation = new RotateAnimation(-180, 0,
				Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
				0.5f);
